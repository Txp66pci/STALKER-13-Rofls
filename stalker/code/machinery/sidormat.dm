...
//		new /datum/data/stalker_equipment("Болты",								"Болты",												/obj/item/stalker/bolts,											300,	ROOKIE),
	...
	"Unbuyable" = list(
		new /datum/data/stalker_equipment("Суп",					"Суп",					/obj/item/reagent_containers/food/snacks/stalker/konserva/soup,				900,	ROOKIE),
		new /datum/data/stalker_equipment("Консервированные бобы",					"Консервированные бобы",					/obj/item/reagent_containers/food/snacks/stalker/konserva/bobi,				750,	ROOKIE),
		new /datum/data/stalker_equipment("Тушёнка",					"Тушёнка",					/obj/item/reagent_containers/food/snacks/stalker/konserva/govyadina2,		900,	ROOKIE),
		new /datum/data/stalker_equipment("Консервированная рыба",					"Консервированная рыба",					/obj/item/reagent_containers/food/snacks/stalker/konserva/fish,				750,	ROOKIE),
		new /datum/data/stalker_equipment("Сырок",					"Сырок",					/obj/item/reagent_containers/food/snacks/stalker/konserva/snack/sirok,		400,	ROOKIE),
		new /datum/data/stalker_equipment("Шоколад",					"Шоколад",				/obj/item/reagent_containers/food/snacks/stalker/konserva/snack/chocolate,	600,	ROOKIE),
		new /datum/data/stalker_equipment("Бисквиты",						"Бисквиты",						/obj/item/reagent_containers/food/snacks/stalker/konserva/galets,			400,	ROOKIE),
		new /datum/data/stalker_equipment("Каша",						"Каша",						/obj/item/reagent_containers/food/snacks/stalker/konserva/kasha,			550,	ROOKIE),
		new /datum/data/stalker_equipment("Консервированная свинина",					"Консервированная свинина",					/obj/item/reagent_containers/food/snacks/stalker/konserva/MREkonserva1,		700,	ROOKIE),
		new /datum/data/stalker_equipment("Консервированная курятина",					"Консервированная курятина",					/obj/item/reagent_containers/food/snacks/stalker/konserva/MREkonserva2,		700,	ROOKIE),
		new /datum/data/stalker_equipment("Консервированные овощи",	"Консервированные овощи",	/obj/item/reagent_containers/food/snacks/stalker/konserva/MREkonserva3,		850,	ROOKIE),
		new /datum/data/stalker_equipment("Бисквиты",						"Бисквиты",						/obj/item/reagent_containers/food/snacks/stalker/konserva/galets,			400,	ROOKIE),
		/////////////////////////////////	Лут с мутантов	///////////////////////////////////////////


		new /datum/data/stalker_equipment("Хвост собаки",					"Хвост собаки",				/obj/item/stalker/loot/mutantparts/dog_tail,			1000,		ROOKIE, sale_price = 600),
		new /datum/data/stalker_equipment("Глаз плоти",					"Глаз плоти",			/obj/item/stalker/loot/mutantparts/flesh_eye,			1800,		ROOKIE, sale_price = 1050),
		new /datum/data/stalker_equipment("Копыто кабана",					"Копыто кабана",			/obj/item/stalker/loot/mutantparts/boar_leg,			6000,		ROOKIE, sale_price = 1800),
		new /datum/data/stalker_equipment("Нога снорка",					"Нога снорка",			/obj/item/stalker/loot/mutantparts/snork_leg,			7000,		ROOKIE, sale_price = 3000),
		new /datum/data/stalker_equipment("Щупальца кровососа",		"Щупальца кровососа",	/obj/item/stalker/loot/mutantparts/bloodsucker,			16000,		ROOKIE, sale_price = 8000),
		new /datum/data/stalker_equipment("Хвост псевдособаки",				"Хвост псевдособаки",		/obj/item/stalker/loot/mutantparts/pseudo_tail,			8000,		ROOKIE, sale_price = 7000),
		new /datum/data/stalker_equipment("Мозг контролёра",			"Мозг контролёра",	/obj/item/stalker/loot/mutantparts/controller_brain,		40000,		ROOKIE, sale_price = 20000),
		new /datum/data/stalker_equipment("Плоть полтергейста",			"Плоть полтергейста",	/obj/item/stalker/loot/mutantparts/poltergeist_skin,		80000,		ROOKIE, sale_price = 40000),


		/////////////////////////////////	Artifacts	///////////////////////////////////////////
		new /datum/data/stalker_equipment("Медуза",			"Медуза",						/obj/item/artifact/meduza,					5000,	ROOKIE,	sale_price = 2500),
		new /datum/data/stalker_equipment("Каменный цветок",		"Каменный цветок",						/obj/item/artifact/stoneflower,				10000,	ROOKIE,	sale_price = 3000),
		new /datum/data/stalker_equipment("Ночная звезда",			"Ночная звезда",						/obj/item/artifact/nightstar,				30000,	ROOKIE,	sale_price = 13000),
		new /datum/data/stalker_equipment("Истощённый каменный цветок",			"Истощённый каменный цветок",					/obj/item/artifact/stoneflower_depleted,			5000,	ROOKIE,	sale_price = 1500),
		new /datum/data/stalker_equipment("Истощённая ночная звезда",			"Истощённая ночная звезда",						/obj/item/artifact/nightstar_depleted,				10000,	ROOKIE,	sale_price = 8000),
		new /datum/data/stalker_equipment("Душа",				"Душа",								/obj/item/artifact/soul,					80000,	ROOKIE,	sale_price = 25000),
		///////////////////////////////////////////////////////////////////////////////////////////
		new /datum/data/stalker_equipment("Вспышка",				"Вспышка",							/obj/item/artifact/flash,					6000,	ROOKIE,	sale_price = 2500),
		new /datum/data/stalker_equipment("Лунный свет",			"Лунный свет",						/obj/item/artifact/moonlight,				12000,	ROOKIE,	sale_price = 3500),
		...
		///////////////////////////////////////////////////////////////////////////////////////////
		new /datum/data/stalker_equipment("Капля",			"Капля",							/obj/item/artifact/droplet,					7000,	ROOKIE,	sale_price = 5000),
		new /datum/data/stalker_equipment("Огненный шар",			"Огненный шар",							/obj/item/artifact/fireball,				15000,	ROOKIE,	sale_price = 7500),
		new /datum/data/stalker_equipment("Кристал",			"Кристал",							/obj/item/artifact/crystal,					60000,	ROOKIE,	sale_price = 15000),
		new /datum/data/stalker_equipment("Мамины буссы",		"Мамины буссы",	/obj/item/artifact/maminibusi,				80000,	ROOKIE,	sale_price = 35000),
		///////////////////////////////////////////////////////////////////////////////////////////
		new /datum/data/stalker_equipment("Кровь камня",		"Кровь камня",						/obj/item/artifact/stone_blood,				4000,	ROOKIE,	sale_price = 2500),
		new /datum/data/stalker_equipment("Пузырь",				"Пузырь",							/obj/item/artifact/bubble,					12000,	ROOKIE,	sale_price = 15000),
		new /datum/data/stalker_equipment("Слюда",				"Слюда",								/obj/item/artifact/mica,					30000,	ROOKIE,	sale_price = 20000),
		new /datum/data/stalker_equipment("Светляк",			"Светляк",							/obj/item/artifact/firefly,					90000,	ROOKIE,	sale_price = 40000),


  	/////////////////////////////////	Trash	//////////////////////////////////////////////
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva,						400,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/MREkonserva1,			200,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/MREkonserva2,			200,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/MREkonserva3,			200,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/bobi,					400,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/fish,					500,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/govyadina,				400,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/shproti,				600,	ROOKIE),
		new /datum/data/stalker_equipment("Консерва",			"Консерва",							/obj/item/trash/konserva/soup,					500,	ROOKIE),
		new /datum/data/stalker_equipment("Использованные стяжки",		"Использованные стяжки",						/obj/item/restraints/handcuffs/cable/zipties/used,250,	ROOKIE),
		///////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////	Medkit components	//////////////////////////////////////////////////
		new /datum/data/stalker_equipment("Противоожоговое",					"Противоожоговое",						/obj/item/stack/medical/ointment,									25,		ROOKIE,	sale_price = 25),
		new /datum/data/stalker_equipment("Пластырь",				"Пластырь",					/obj/item/stack/medical/bruise_pack,								25,		ROOKIE,	sale_price = 25),
		new /datum/data/stalker_equipment("Таблетка угля",				"Таблетка угля",				/obj/item/reagent_containers/pill/charcoal,							125,	ROOKIE,	sale_price = 125),
		new /datum/data/stalker_equipment("Эпинефрин",						"Epipen",						/obj/item/reagent_containers/pill/stalker/injector/epinephrine,		125,	ROOKIE,	sale_price = 125),
		new /datum/data/stalker_equipment("Улучшенный пластырь",				"Улучшенный пластырь",					/obj/item/reagent_containers/pill/patch/styptic,					250,	ROOKIE,	sale_price = 250),
		new /datum/data/stalker_equipment("Противоожоговый пластырь",					"Противоожоговый пластырь",					/obj/item/reagent_containers/pill/patch/silver_sulf,				250,	ROOKIE,	sale_price = 250),
		new /datum/data/stalker_equipment("Боевой пластырь",				"Боевой пластырь",					/obj/item/reagent_containers/pill/patch/synthflesh,					250,	ROOKIE,	sale_price = 250),
		new /datum/data/stalker_equipment("Инжектор противотравмирующего",				"Инжектор противотравмирующего",				/obj/item/reagent_containers/pill/stalker/injector/brute,			250,	ROOKIE,	sale_price = 250),
		new /datum/data/stalker_equipment("Инжектор противоожоговово",				"Инжектор противоожоговово",				/obj/item/reagent_containers/pill/stalker/injector/burn,			250,	ROOKIE,	sale_price = 250),
		new /datum/data/stalker_equipment("Инжектор крови",				"Инжектор крови",				/obj/item/reagent_containers/pill/stalker/injector/blood,			250,	ROOKIE,	sale_price = 150),
		new /datum/data/stalker_equipment("Инжектор обезболивающего",		"Инжектор обезболивающего",			/obj/item/reagent_containers/pill/stalker/injector/painkiller,		250,	ROOKIE,	sale_price = 150),
		new /datum/data/stalker_equipment("Инжектор антитоксинов",			"Инжектор антитоксинов",			/obj/item/reagent_containers/pill/stalker/injector/toxin,			250,	ROOKIE,	sale_price = 150),
		new /datum/data/stalker_equipment("Кислородный инжектор",			"Кислородный инжектор",				/obj/item/reagent_containers/pill/stalker/injector/oxygen,			250,	ROOKIE,	sale_price = 150),
		new /datum/data/stalker_equipment("Инжектор антирада",			"Инжектор антирада",				/obj/item/reagent_containers/pill/stalker/injector/antirad,			250,	ROOKIE,	sale_price = 150),


		/////////////////////////////////Rare Firearms	//////////////////////////////////////////////////
		new /datum/data/stalker_equipment("Арисака",					"Арисака",						/obj/item/gun/ballistic/rifle/boltaction/arisaka,			7550,	ROOKIE,	sale_price = 22000),
		new /datum/data/stalker_equipment("Карабинер",					"Карабинер",					/obj/item/gun/ballistic/rifle/boltaction/karabiner,			7550,	ROOKIE,	sale_price = 22000),
		new /datum/data/stalker_equipment("Спрингфилд",				"Спрингфилд",					/obj/item/gun/ballistic/rifle/boltaction/springfield,		7550,	ROOKIE,	sale_price = 22000),
		new /datum/data/stalker_equipment("Стэн MK II",					"Стэн MK II",					/obj/item/gun/ballistic/automatic/sten,						7550,	ROOKIE,	sale_price = 22000),
		new /datum/data/stalker_equipment("ПП Стерлинг",	"ПП Стерлинг",		/obj/item/gun/ballistic/automatic/sterling,					7550,	ROOKIE,	sale_price = 22000),
		new /datum/data/stalker_equipment("M3A1 Гриз Ган",			"M3A1 Гриз Ган",				/obj/item/gun/ballistic/automatic/m3a1,						7550,	ROOKIE,	sale_price = 22000),
		new /datum/data/stalker_equipment("Рейсинг Модель 55",			"Рейсинг Модель 55",				/obj/item/gun/ballistic/automatic/reising,					7550,	ROOKIE,	sale_price = 35000),
		new /datum/data/stalker_equipment("МП-40",						"МП-40",						/obj/item/gun/ballistic/automatic/mp40,						7550,	ROOKIE,	sale_price = 35000),
		new /datum/data/stalker_equipment("МП 3008",					"МП 3008",						/obj/item/gun/ballistic/automatic/mp3008,					7550,	ROOKIE,	sale_price = 35000),
		new /datum/data/stalker_equipment("ППШ-43",						"ППШ-43",						/obj/item/gun/ballistic/automatic/pps43,					7550,	ROOKIE,	sale_price = 35000),
		new /datum/data/stalker_equipment("ПП-19 Бизон",				"ПП-19 Бизон",					/obj/item/gun/ballistic/automatic/bizon,					7550,	ROOKIE,	sale_price = 40000),
		new /datum/data/stalker_equipment("Смит и Вессон M76",			"Смит и Вессон M76",			/obj/item/gun/ballistic/automatic/m76,						7550,	ROOKIE,	sale_price = 40000),
		new /datum/data/stalker_equipment("Скорпион",					"Скорпион",						/obj/item/gun/ballistic/automatic/skorpion,					7550,	ROOKIE,	sale_price = 20000),
		new /datum/data/stalker_equipment("СКС",						"СКС",							/obj/item/gun/ballistic/rifle/semiautobolt/sks,				7550,	ROOKIE,	sale_price = 25000),
		new /datum/data/stalker_equipment("ФН ФАЛ",						"ФН ФАЛ",						/obj/item/gun/ballistic/automatic/fnfal,					7550,	ROOKIE,	sale_price = 50000),
		new /datum/data/stalker_equipment("ФН ФАЛ",						"ФН ФАЛ",						/obj/item/gun/ballistic/automatic/woodfnfal,				7550,	ROOKIE,	sale_price = 50000),
		new /datum/data/stalker_equipment("ФАМАС",						"ФАМАС",						/obj/item/gun/ballistic/automatic/famas,					7550,	ROOKIE,	sale_price = 40000),
		new /datum/data/stalker_equipment("Стейр АУГ",					"Стейр АУГ",					/obj/item/gun/ballistic/automatic/aug,						7550,	ROOKIE,	sale_price = 40000),
		new /datum/data/stalker_equipment("ВЗ. 58",						"ВЗ. 58",						/obj/item/gun/ballistic/automatic/vz58,						7550,	ROOKIE,	sale_price = 40000),
		new /datum/data/stalker_equipment("M16A1",						"M16A1",						/obj/item/gun/ballistic/automatic/m16,						7550,	ROOKIE,	sale_price = 30000),
		new /datum/data/stalker_equipment("M14",				"M14",					/obj/item/gun/ballistic/automatic/m14,						7550,	ROOKIE,	sale_price = 55000),
		new /datum/data/stalker_equipment("M16A4",						"M16A4",						/obj/item/gun/ballistic/automatic/m16a4,					7550,	ROOKIE,	sale_price = 50000),
		new /datum/data/stalker_equipment("M4",					"M4",					/obj/item/gun/ballistic/automatic/m4,						7550,	ROOKIE,	sale_price = 30000),
		new /datum/data/stalker_equipment("Армалайт АР-15",				"Армалайт АР-15",				/obj/item/gun/ballistic/automatic/ar15,						7550,	ROOKIE,	sale_price = 30000),
		new /datum/data/stalker_equipment("ФН СКАР-Х",					"ФН СКАР-Х",					/obj/item/gun/ballistic/automatic/scarh,					7550,	ROOKIE,	sale_price = 60000),
		...
		new /datum/data/stalker_equipment("Люгер П08",					"Люгер П08",					/obj/item/gun/ballistic/automatic/pistol/luger,				7550,	ROOKIE,	sale_price = 25000),
		new /datum/data/stalker_equipment("Вальтер П38",				"Вальтер П38",					/obj/item/gun/ballistic/automatic/pistol/walther,			7550,	ROOKIE,	sale_price = 20000),
		new /datum/data/stalker_equipment("Стечкин",				"Стечкин",				/obj/item/gun/ballistic/automatic/pistol/aps,				7550,	ROOKIE,	sale_price = 20000),
		new /datum/data/stalker_equipment("ОЦ- Пернач",				"ОЦ- Пернач",					/obj/item/gun/ballistic/automatic/pistol/pernach,			7550,	ROOKIE,	sale_price = 20000),
		new /datum/data/stalker_equipment("Маузер к96",					"Маузер к96",					/obj/item/gun/ballistic/automatic/pistol/mauser,			7550,	ROOKIE,	sale_price = 12000),
		new /datum/data/stalker_equipment("Глок 17",					"Глок 17",						/obj/item/gun/ballistic/automatic/pistol/glock,				7550,	ROOKIE,	sale_price = 18000),
		new /datum/data/stalker_equipment("TT-30",						"TT-30",						/obj/item/gun/ballistic/automatic/pistol/tt30,				7550,	ROOKIE,	sale_price = 12000),
		new /datum/data/stalker_equipment("ФН 5-7",					"ФН 5-7",					/obj/item/gun/ballistic/automatic/pistol/fiveseven,			7550,	ROOKIE,	sale_price = 20000),
		new /datum/data/stalker_equipment(".500 Бык",					".500 Бык",					/obj/item/gun/ballistic/revolver/c500revolver,				7550,	ROOKIE,	sale_price = 100000),
		new /datum/data/stalker_equipment("Вальтер ПП",					"Вальтер ПП",					/obj/item/gun/ballistic/automatic/pistol/waltherpp,			7550,	ROOKIE,	sale_price = 15000),
		new /datum/data/stalker_equipment("ЧС 83",						"ЧС 83",						/obj/item/gun/ballistic/automatic/pistol/cz83,				7550,	ROOKIE,	sale_price = 12000),
		new /datum/data/stalker_equipment("Серебрянная Беретта",				"Серебрянная Беретта",				/obj/item/gun/ballistic/automatic/pistol/silvermarta,		7550,	ROOKIE,	sale_price = 50000),
		/////////////////////////////////Rare Firearm Ammo	//////////////////////////////////////////////////
		new /datum/data/stalker_equipment("Пистолетный Магазин Стечкина (9x18mm)",				"Пистолетный магазин стечкина (9x18mm)",			/obj/item/ammo_box/magazine/stalker/m9x18aps,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Бизона (9x18mm)",					"магазин Бизона (9x18mm)",				/obj/item/ammo_box/magazine/stalker/m9x18bizon,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Люгера (9x19mm)",				"Магазин Люгера (9x19mm)",		/obj/item/ammo_box/magazine/stalker/m9x19luger,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Вальтер П38 (9x19mm)",		"Магазин Вальтер П38 (9x19mm)",	/obj/item/ammo_box/magazine/stalker/m9x19waltherp38,	250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Глока (9x19mm)",				"Магазин Глока (9x19mm)",		/obj/item/ammo_box/magazine/stalker/m9x19glock,			250,	ROOKIE,	sale_price = 150),
		new /datum/data/stalker_equipment("Магазин ФН 5-7 (5.7×28mm)",		"Магазин ФН 5-7 (5.7×28mm)",/obj/item/ammo_box/magazine/stalker/m57x28fiveseven,	250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Вальтер ПП (9x19mm)",		"Магазин Вальтер ПП (9x19mm)",	/obj/item/ammo_box/magazine/stalker/m9x19waltherpp,		250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин ЧС 83 (9x18mm)",				"Магазин ЧС 83 (9x18mm)",		/obj/item/ammo_box/magazine/stalker/m9x18cz83,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Рейсинг Модель 55 (.45)",						"Магазин Рейсинг Модель 55 (.45)",				/obj/item/ammo_box/magazine/stalker/reising,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин MAT-49 (9x19mm)",					"Магазин MAT-49 (9x19mm)",				/obj/item/ammo_box/magazine/stalker/m9x19mat49,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин М14 (7.62x51)",						"Магазин М14 (7.62x51)",				/obj/item/ammo_box/magazine/stalker/m14,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин СКАРа (7.62x51)",					"Магазин М14 (7.62x51)",				/obj/item/ammo_box/magazine/stalker/scarh,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин СКС (7.62x51)",						"Магазин СКС (7.62x51)",				/obj/item/ammo_box/magazine/stalker/sks,				250,	ROOKIE,	sale_price = 500), //SKS IS INTERNAL MAG :megatroll:
		new /datum/data/stalker_equipment("Магазин ВЗ .58 (7.62x39)",					"Магазин ВЗ .58 (7.62x39)",			/obj/item/ammo_box/magazine/stalker/vz58,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин ППШ (7.62x25)",					"Магазин ППШ (7.62x25)",				/obj/item/ammo_box/magazine/stalker/pps43,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин МП-40 (9x19mm)",					"Магазин МП-40 (9x19mm)",				/obj/item/ammo_box/magazine/stalker/mp40,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Стэна МК II (9x19mm)",				"Магазин Стэна МК II (9x19mm)",			/obj/item/ammo_box/magazine/stalker/sten,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Стерлинга (9x19mm)",					"Магазин Стерлинга (9x19mm)",			/obj/item/ammo_box/magazine/stalker/sterling,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин М3А1 (9x19mm)",			"Магазин М3А1 (9x19mm)",	/obj/item/ammo_box/magazine/stalker/m3a1,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин СнВ М76 (9x19mm)",					"Магазин СнВ М76 (9x19mm)",			/obj/item/ammo_box/magazine/stalker/m9x19m76,			250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Скорпиона (9x19mm)",					"Магазин Скорпиона (9x19mm)",			/obj/item/ammo_box/magazine/stalker/m9x19skorpion,		250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Магазин Маузера (7.62x25mm)",			"Магазин Маузера (7.62x25mm)",	/obj/item/ammo_box/magazine/stalker/mauser,				250,	ROOKIE,	sale_price = 500),
		new /datum/data/stalker_equipment("Увеличенный Магазин Маузера (7.62x25mm)","Увеличенный Магазин Маузера (7.62x25mm)",/obj/item/ammo_box/magazine/stalker/mauser/ext,	250,	ROOKIE,	sale_price = 500),
		)
	))
