...
GLOBAL_LIST_INIT(global_sidormat_list, list(
	...
	"Пистолеты пуллеметы" = list(
		...
		new /datum/data/stalker_equipment("FN P90",			"FN P90",			/obj/item/gun/ballistic/automatic/p90,						38000,	ROOKIE, initial_stock = SPECIALTY_AMOUNT, faction = "Наёмники"),
		),
	...
	"Автоматы" = list(
		...
		new /datum/data/stalker_equipment("FN F2000S",		"FN F2000S",		/obj/item/gun/ballistic/automatic/fnf2000s,					100000,	EXPERT, initial_stock = SPECIALTY_AMOUNT, faction = "Наёмники")
	...
	"Винтовки" = list(
		...
		new /datum/data/stalker_equipment("AWSM",			"AWSM",				/obj/item/gun/ballistic/awm,								80000,	ROOKIE, initial_stock = SPECIALTY_AMOUNT, faction = "Наёмники")
		),
	...
	"Патроны" = list(
		...
		new /datum/data/stalker_equipment(".338 Lapua Magnum Box",		"Коробка .338 Lapua Magnum ",					/obj/item/ammo_box/stalker/b338,						60000,	ROOKIE,			initial_stock = PISTOL_AMOUNT,sale_price =700,faction = "Наёмники"),
		),
	...
	"Костюмы" = list(
		...
		new /datum/data/stalker_equipment("Clear Sky Coat",				"Куртка Чистого Неба",			/obj/item/clothing/suit/hooded/kozhanka/cs_hood,			15000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Чистое Небо"),
		new	/datum/data/stalker_equipment("Bandit Jacket",				"Бандитская куртка",			/obj/item/clothing/suit/hooded/kozhanka/banditka,			6000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Бандиты"),
		...
		new	/datum/data/stalker_equipment("Military Service Armor",		"Армейская Броня",	/obj/item/clothing/suit/army,								15000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		new	/datum/data/stalker_equipment("Military Service Vest",		"Военный жилет",		/obj/item/clothing/suit/mil,								15000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		...
		new /datum/data/stalker_equipment("Defender II Vest",			"Дефендер II",			/obj/item/clothing/suit/d2,									24000,		EXPERIENCED,initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		new /datum/data/stalker_equipment("Mercenary Outfit",			"Броня Наёмников",			/obj/item/clothing/suit/hooded/kombez/mercenary,			25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Наёмники"),
		new /datum/data/stalker_equipment("Ecologist Mercenary Outfit",	"Научная броня наёмников",/obj/item/clothing/suit/hooded/kombez/eco_mercenary,		25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Экологи"),
		new /datum/data/stalker_equipment("Bandit Outfit",				"Броня Бандитов",			/obj/item/clothing/suit/hooded/kombez/kombez_bandit,		25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Бандиты"),
		...
		new /datum/data/stalker_equipment("Black Trenchcoat",			"Кожаный плащ",			/obj/item/clothing/suit/hooded/kozhanka/banditka/coat,		12500,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Бандиты"),
		...
		new /datum/data/stalker_equipment("Berill-5M",					"Берилл 5-М",				/obj/item/clothing/suit/berill,								50000,		EXPERIENCED,initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		new /datum/data/stalker_equipment("Guardian of Freedom",		"Защитник Свободы",		/obj/item/clothing/suit/guardian_of_freedom,				50000,		EXPERIENCED,initial_stock = PISTOL_AMOUNT,faction = "Свобода"),
		new /datum/data/stalker_equipment("Sentinel of Freedom",	   	"Комбинезон Ветер Свободы",		/obj/item/clothing/suit/hooded/kombez/veter,				25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Свобода"),
		new /datum/data/stalker_equipment("Wind of Freedom",			"Страж Свободы",			/obj/item/clothing/suit/hooded/strazh,				40000,		EXPERIENCED,initial_stock = PISTOL_AMOUNT,faction = "Свобода"),
		new /datum/data/stalker_equipment("PZ-1	",						"Броня Монолита",						/obj/item/clothing/suit/hooded/kombez/monolith,				25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Монолит", sale_price = 8000),
		new /datum/data/stalker_equipment("Monolith Scientific Suit",	"Научная броня Монолита",	/obj/item/clothing/suit/hooded/sealed/monolith,				60000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Монолит"),
		new /datum/data/stalker_equipment("PS5-M",						"ПС5-М",					/obj/item/clothing/suit/hooded/kombez/ps5m,					25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Долг"),
		new /datum/data/stalker_equipment("CS-3a body armor",			"Броня ЧН-3a",			/obj/item/clothing/suit/hooded/cs_medium,					25000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Чистое Небо"),
		new /datum/data/stalker_equipment("Heavy Mercenary Armour",		"Тяжёлая броня Наёмников",	/obj/item/clothing/suit/assaultmerc,						50000,		EXPERIENCED,initial_stock = PISTOL_AMOUNT,faction = "Наёмники"),
		new /datum/data/stalker_equipment("Mercenary Ace Suit",			"Научная броня наёмников",		/obj/item/clothing/suit/hooded/sealed/merc,					60000,		ROOKIE,		initial_stock = PISTOL_AMOUNT,faction = "Наёмники"),
		new /datum/data/stalker_equipment("CS-1 Body Armor",			"Броня ЧН-1",			/obj/item/clothing/suit/cs_heavy,							60000,		VETERAN,	initial_stock = PISTOL_AMOUNT,faction = "Чистое Небо"),
		new /datum/data/stalker_equipment("PSZ-9D",						"ПСЗ-9МД",					/obj/item/clothing/suit/psz9d,								60000,		VETERAN,	initial_stock = PISTOL_AMOUNT,faction = "Долг"),
		new	/datum/data/stalker_equipment("PSZ-9M",						"ПСЗ-9М",					/obj/item/clothing/suit/hooded/sealed/psz9md,				75000,		VETERAN,	initial_stock = PISTOL_AMOUNT,faction = "Долг"),
		new	/datum/data/stalker_equipment("SSP-99 Ecologist",			"ССП-99",			/obj/item/clothing/suit/hooded/sealed/ecolog,				75000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Экологи"),
		new	/datum/data/stalker_equipment("SSP-99M Ecologist",			"ССП-99М",		/obj/item/clothing/suit/hooded/sealed/ecologm,				100000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Экологи"),
		new	/datum/data/stalker_equipment("SEVA",						"СЕВА",						/obj/item/clothing/suit/hooded/sealed/seva,					125000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Экологи"),
		new /datum/data/stalker_equipment("SKAT-9M",					"СКАТ-М9",					/obj/item/clothing/suit/skat,								150000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		...
		new	/datum/data/stalker_equipment("Exoskeleton",				"Экзоскелет",				/obj/item/clothing/suit/hooded/sealed/exoskelet,			400000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Чистое Небо"),
		new	/datum/data/stalker_equipment("Exoskeleton",				"Экзоскелет",				/obj/item/clothing/suit/hooded/sealed/exoskelet,			400000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		new	/datum/data/stalker_equipment("Merc Exoskeleton",			"Экзоскелет Наёмников",			/obj/item/clothing/suit/hooded/sealed/exoskelet/merc,		400000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Наёмники"),
		new	/datum/data/stalker_equipment("Bandit Exoskeleton",			"Экзоскелет Бандитов",		/obj/item/clothing/suit/hooded/sealed/exoskelet/bandit,		400000,		ZONE_LEGEND,	initial_stock = PISTOL_AMOUNT,faction = "Бандиты"),
		new	/datum/data/stalker_equipment("Duty Exoskeleton",			"Экзоскелет Долга",			/obj/item/clothing/suit/hooded/sealed/exoskelet/duty,		400000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Долг"),
		new	/datum/data/stalker_equipment("Freedom Exoskeleton",		"Экзоскелет Свободы",		/obj/item/clothing/suit/hooded/sealed/exoskelet/freedom,	400000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Свобода"),
		new	/datum/data/stalker_equipment("Monolith Exoskeleton",		"Экзоскелет Монолита",		/obj/item/clothing/suit/hooded/sealed/exoskelet/monolith,	400000,		EXPERT,	initial_stock = PISTOL_AMOUNT,faction = "Монолит")
	),
	...
	"Маски и шлемы" = list(
		...
		new /datum/data/stalker_equipment("Mercenary Gas Mask",			"Противогаз",			/obj/item/clothing/mask/gas/stalker/mercenary,					7500,	ROOKIE,	initial_stock = PISTOL_AMOUNT,faction = "Наёмники"),
		...
		new /datum/data/stalker_equipment("Guardian of Freedom helmet",	"Шлем Защитника Свободы",	/obj/item/clothing/head/hardhat/tactical/guardian_of_freedom,	12500,	EXPERIENCED, initial_stock = PISTOL_AMOUNT,faction = "Свобода"),
		...
		new /datum/data/stalker_equipment("Assault Helmet",	    		"Шлем Наёмников",				/obj/item/clothing/head/assaultmerc,							30000,	EXPERIENCED,	initial_stock = PISTOL_AMOUNT,faction = "Наёмники"),
		new /datum/data/stalker_equipment("Sphera-M12",			 		"Сфера M12",					/obj/item/clothing/head/spheram,								30000,	EXPERIENCED,	initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		new /datum/data/stalker_equipment("SKAT-9M Helmet",				"Шлем СКАТ-M9",				/obj/item/clothing/head/skathelmet,								90000,	VETERAN, 		initial_stock = PISTOL_AMOUNT,faction = "Военные"),
		new /datum/data/stalker_equipment("MASKA-1 SCH Helmet",			"Шлем МАСКА-1Щ",			/obj/item/clothing/head/maska_1,								12500,	EXPERIENCED,	initial_stock = PISTOL_AMOUNT,faction = "Чистое Небо"),
	...
	"Медикаменты" = list(
		...
		new /datum/data/stalker_equipment("Advanced Scientific Kit",	"Научная аптечка",	/obj/item/storage/firstaid/ecologists,							20000,	VETERAN,initial_stock = RIFLE_AMOUNT,faction = "Экологи",sale_price = 3000),
		new /datum/data/stalker_equipment("Scientific medkit",			"Научная аптечка",		/obj/item/storage/firstaid/sciencemedkit,						7000,	EXPERIENCED,initial_stock = RIFLE_AMOUNT,faction = "Экологи",sale_price = 1000),
		...
		new /datum/data/stalker_equipment("Scientific Stim",			"Научный стимулятор",			/obj/item/reagent_containers/pill/stalker/injector/scistim,				24000,	EXPERT,initial_stock = RIFLE_AMOUNT,faction = "Экологи",sale_price = 10000),
	...
	"Другое" = list(
		...
		new /datum/data/stalker_equipment("Weed Rollie",						"Косяк",											/obj/item/clothing/mask/cigarette/rollie/trippy,					1000,	ROOKIE,	initial_stock = PISTOL_AMOUNT*4,faction = "Свобода"),
...
//		new /datum/data/stalker_equipment("Bolts",								"Bolts",												/obj/item/stalker/bolts,											300,	ROOKIE),
		new /datum/data/stalker_equipment("HandCuffs",							"Наручники",											/obj/item/restraints/handcuffs/cable/zipties,						500,	ROOKIE, initial_stock = PISTOL_AMOUNT,faction = "Бандиты"),
		...
		new /datum/data/stalker_equipment("Flash Grenade",						"Светошумовая граната",										/obj/item/grenade/flashbang,										10000,	EXPERIENCED,initial_stock = PISTOL_AMOUNT*4,faction = "Наёмники"),
		...
		new /datum/data/stalker_equipment("Russian Vocabulary",					"Самоучитель русского языка",									/obj/item/codespeak_manual/russian,									10000,	ROOKIE,	initial_stock = SPECIALTY_AMOUNT,faction = "Долг",sale_price = 8000),
		new /datum/data/stalker_equipment("English Vocabulary",					"Самоучитель английского языка",									/obj/item/codespeak_manual/english,									10000,	ROOKIE,	initial_stock = SPECIALTY_AMOUNT,faction = "Чистое Небо",sale_price = 8000),
		new /datum/data/stalker_equipment("German Vocabulary",					"Самоучитель немецкого языка",									/obj/item/codespeak_manual/german,									10000,	ROOKIE,	initial_stock = SPECIALTY_AMOUNT,faction = "Экологи",sale_price = 8000),
	...
	"Детекторы" = list(
		...
		new /datum/data/stalker_equipment("Veles",		"Велес",					/obj/item/detector/veles,				66000,	ROOKIE,	sale_price =50000, faction = "Экологи",initial_stock = SPECIALTY_AMOUNT),
		),
